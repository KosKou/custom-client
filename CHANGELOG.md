...
###### `v1.0.0`
- Sidebar component:
	- item with optional class (_navAuth.js)
	- nav link with optional variant (_navAuth.js)
	- external urls allowed (_navAuth.js)
...
###### `2017.08.01`
- Sidebar component: 
	- title item with optional wrapper and class (_navAuth.js)
...
- data driven Sidebar component (_navAuth.js)
