...
class KnowledgeReport extends Component{
          ...
          .then(response =>{
            ...
            response.data.forEach((category) =>{
              ...
              activities.forEach(activity => {
                let identifier = activity.knowledges.some(k => k.id === category.id)
                if (identifier){
                  temp.value += 1;
                }
              })
            ...
            pieSeries.dataFields.category = "known";
            //Exporting
            chart.exporting.menu = new am4core.ExportMenu();
            chart.exporting.menu.align = "left";
            chart.exporting.menu.verticalAlign = "top";
            chart.exporting.title = "REPORTE"
            chart.exporting.filePrefix = "Reporte de Conocimientos"
  ...
  render() {
    ...
    return (
      <>
        <h1>Reporte de Área de Conocimiento</h1>
        ...
        <Card>
          ...
          <CardBody>
                  ...
                  <div>
                    ...
                    <ExcelFile filename="Reporte" element={<Button color="success">Exportar a Excel</Button>}>
                      <ExcelSheet data={this.state.activities} name="Categorias">
                        ...
                        <ExcelColumn label="Conocimientos" value={(col) => {
                          let knownString = ""
                          col.knowledges.map(
                            known => {
                              if(knownString === ""){
            ...
            {/*<BootstrapTable keyField='id' bootstrap4={true} data={this.state.activities}*/}
            {/*columns={columns} striped={true} hover={true} pagination={paginationFactory()}/>*/}
          </CardBody>
        </Card>
        <div hidden={true}>
